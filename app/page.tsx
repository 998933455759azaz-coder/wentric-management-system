    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="mx-auto flex max-w-6xl flex-col gap-16 px-6 py-8 md:px-10 md:py-12">
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-3"><span className="grid size-10 place-items-center rounded-xl bg-primary text-primary-foreground"><Bot size={22} /></span><span className="font-semibold tracking-tight">O‘zbekcha Bot</span></div>
        ...
        <section className="grid items-center gap-12 md:grid-cols-[1.15fr_.85fr] md:py-12">
          <div className="flex flex-col gap-7">
            <div className="w-fit rounded-full border border-border bg-card px-3 py-1 text-xs font-medium text-muted-foreground">Telegram yordamchi platformasi</div>
            <h1 className="max-w-2xl text-balance text-5xl font-semibold tracking-[-0.05em] md:text-7xl">O‘zbek tilida oddiy, aqlli yordamchi.</h1>
